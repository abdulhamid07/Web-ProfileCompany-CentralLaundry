                         ...
                         <?php
                               ...
                               $cetak="";
                                if(isset($_GET['halaman'])){
                                  ...
                                  $q  = mysql_query("SELECT COUNT(*) AS jumData FROM news");
                                  $data = mysql_fetch_array($q);
                                  $q=mysql_query("select *,u.nama from news n
                                                left join user u on u.kd_user=n.penulis order by tgl desc $cetak LIMIT $offset, $dataPerhalaman");
                                $offset=0;
                            ?>
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">News And Blog</h3>
                                </div>
                                 ...
                                 <?php echo getMessage(); ?>
                                   ...
                                   <p>
                                    ...
                                    <tbody> 
                                        ...
                                        <td><img src="../images/news/<?php echo $result['img'] ?>" alt="Gambar news" width="119px" height="88px"></td>
