<?php
    $id=$_GET['id'];
    $q=mysql_query("select * from news where no='$id' limit 0,1");
                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                                ...
                                <div class="box-header">
                                    <h3 class="box-title">Tambah News/Blog</h3>
                                </div>
                                <div class="box-body table-responsive">
                                    ...
                                    <label>Gambar : </label>
                                    <img src="../images/news/<?php echo $dn['img'] ?>" width="300px" height="160px">
                                    ...
                                    <select name="tipe" class="form-control input-sm" required>
                                        <option value="">-- Tipe Artikel --</option>
                                        <option value="N"<?php if($dn['tipe']=='N'){ ?> selected="selected"<?php } ?>>News & Info</option>
                                        <option value="B" <?php if($dn['tipe']=='B'){ ?> selected="selected"<?php } ?>>Artikel Blog</option>
                                    </select>
